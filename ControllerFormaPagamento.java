...
public class ControllerFormaPagamento {
    ...
    * return ModelFormaPagamento
    */
    public ModelFormaPagamento getFormaPagamentoController(String pDescricaoFormaPagamento){
        return this.daoFormaPagamento.getFormaPagamentoDAO(pDescricaoFormaPagamento);
    }
