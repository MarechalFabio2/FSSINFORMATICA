...
public class ModelCliente {
    ...
    public String toString() {
        return "ModelCliente {" + "::idCliente = " + this.idCliente + "::cliNome = " + this.cliNome + "::cliCPF = " + this.cliCPF + "::cliEndereco = " + this.cliEndereco + "::cliBairro = " + this.cliBairro + "::cliCidade = " + this.cliCidade + "::cliEstado = " + this.cliEstado + "::cliCep = " + this.cliCep + "::cliTelefone = " + this.cliTelefone + "}";
    }
}
