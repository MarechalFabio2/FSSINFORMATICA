...
public class ModelVendasProdutos {
    ...
    private double venProValorVenda;
    ...
    public String toString() {
        return "ModelVendasProdutos {" + "::idVendaProduto = " + this.idVendaProduto + "::produto = " + this.produto + "::vendas = " + this.vendas + "::venProValor = " + this.venProValor + this.vendas + "::venProValorVenda = " + this.venProValorVenda + "::venProQuantidade = "  + this.venProQuantidade + "}";
    }

    /**
     * @return the venProValorVenda
     */
    public double getVenProValorVenda() {
        return venProValorVenda;
    }

    /**
     * @param venProValorVenda the venProValorVenda to set
     */
    public void setVenProValorVenda(double venProValorVenda) {
        this.venProValorVenda = venProValorVenda;
    }
}
